...
workstation, and your home directory is generally stored locally.  To
reach other users' calendars in their home directories, you will need
to mount those filesystems with some remote access protocol like samba
or nfs. Another alternative is \URL{https://syncthing.net/} so your
local workstation has a synchronized copy of the other users'
calendar.
...
\section{Menus}
    ...
    \subsection{Option Menu}
        ...
        \item[Notice Window Height]
            Controls the height of the notice window. The main window
            height is recomputed based on the notice window height.
