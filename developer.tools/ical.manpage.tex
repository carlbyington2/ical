...
By today's standards, this is an ancient program. Much of the code
is 33 years old and counting, and it still runs nicely. Performance
is no longer an issue. My calendar has 3500 entries from the last
25 years.
...
\section{Items}
    ...
    \subsection{Appointments}
        ...
        Appointments have an associated time zone that defaults to
        local time. The appointment display always shows the local
        time for the appointment. Suppose your local time is Denver
        and you add a 12:00 appointment in the Los Angeles time zone.
        The window will show this appoint at 13:00. Now if you fly to
        Los Angeles, and your workstation picks up the time zone
        change, the appointment will show at 12:00.

        Appointments created with the default local time zone will not
