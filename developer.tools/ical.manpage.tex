...
By todays standards, this is an ancient program. Much of the code
is 33 years old and counting, and it still runs nicely. Please
...
source $d/timeofday.tcl
source $d/weeknumber.tcl
\end{verbatim}
