...
\setDate{2026-07-28}    %%%% must be manually set
...
\begin{Name}{1}{ical}{Sanjay Ghemawat}{ical \Version}{}
...
\item[\oOptArg{-nodisplay}{}]
    Ignore the DISPLAY environment variable.

\item[\OptArg{-calendar}{ filename}]
    The  calendar  is read from the specified \Arg{filename}.
    See the description of calendar files for more information.
...
\item[\oOptArg{-print}{ 1|2|4|8|10|month}]
    Generate a single page calendar in postscript format to stdout for
...
\section{Windows}
    ...
    \subsection{Menubar}
        ...
        menu allows you to cre‐ ate and destroy application
        windows.
...
\section{Items}
    ...
    \subsection{Appointments}
        ...
        middle mouse button held down. The appointment can be resized
        by dragging with the right mouse button held down.
        ...
        appointment is enlarged with the right mouse button.
        Likewise, the right mouse button will refuse to shrink an
        appointment window if the appointment text completely fills
    ...
    \subsection{Todo Items}
        ...
        little check-box right next to the displayed item.
...
\section{Customization}
    ...
    Other aspects of ical's behavior can be controlled via X
    Resources.
    ...
    \subsection{Dimensions}
        ...
        \item[Ical.itemSelectWidth]
            ...
            option is 1 because on color displays selection is
        ...
        \item[Ical.Reminder.geometry]
            ...
            just specify the window posi‐ tion here.  The
    ...
    \subsection{Colors}
        ...
        *background in your resources because it will break a number
        ...
        \item[Ical.itemOverflowColor/Ical.itemOverflowStipple]
            ...
            that overflows out of the ap‐ pointment area.  On
            color displays, the default overflow background is
            SlateBlue3 and no stippling is done (specified by an empty
            stipple option).  On monochrome displays, the default
            overflow background is black, and the default overflow
            stippling is gray50.
    ...
    \subsection{Fonts}
        \begin{Description}\setlength{\itemsep}{0cm}
        The following resources can be used to customize ical's use of
        fonts.

        \item[Ical.fontFamily]
            Preferred font family.  Fonts for various purposes are
            obtained from this family unless overridden with
            one of the specifications below.  The default font family
            is times.  Some other font families you can specify here
            are charter, new century school book, and
            helvetica.  My personal favorite is new century
            schoolbook.

        \item[Ical.fixedFontFamily]
        ...
        \item[Ical.weekdayFont]
            Font used for displaying days of the week.

        \item[Ical.weekendFont]
            Font used for displaying weekends.

        \item[Ical.interestFont]
            Font used to highlight interesting dates.

        \item[Ical.weekendInterestFont]
            Font used to highlight interesting dates on weekends and holidays.

        \item[Ical.smallHeadingFont]
            Font used for small headings.

        \item[Ical.largeHeadingFont]
            Font used for large headings.

        \item[Ical*<class>*font]
            Font used for windows of a certain class.  Possible values
            for <class> are Dialog, Button, Label, Menubutton, Menu,
            Listbox, and Reminder.

    \subsection{Tcl Code}
        Users can also customize ical by writing tcl code and storing
        ...
        These customizations can be placed in the file site.tcl in
        either the ical library directory, or its parent directory.
        (By default, ical looks for site.tcl in
        /usr/local/lib/ical/v[version]/, and /usr/local/lib/ical/, but
        these directories may be located elsewhere on your
        system.)  The site specific files will be loaded in before any
...
\section{Menus}
    \subsection{File Menu}
        ...
        \item[Re-Read]
            ...
            menu entry only so for people who do not want to wait for
            ical's periodic checks.
    ...
    \subsection{Item Menu}
        ...
        \item[Change Alarms]
            ...
            selected appointments.  You can make this change for all
